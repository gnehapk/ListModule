...
var pluginOpts = pkg.GitProjectsProps;
...
gulp.task('serve', ["eslint", "jsLibraries", "cssLibraries", "resource", "copy", "preload", "sass", "jsbundle"], function() {
  browserSync.init({
    server: {
      baseDir: paths.dest,
...
// Common task
gulp.task("common", ["eslint", "jsLibraries", "cssLibraries", "resource", "copy", "preload", "sass", "jsbundle", "serve"]);
